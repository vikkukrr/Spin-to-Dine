...
const badges = [
  {
    ...
    icon: '🎰',
    criteria: { type: 'spin_count', threshold: 1 }
  },
  {
    name: 'Spin Master',
    description: 'Completed 10 spins',
    icon: '🔄',
    criteria: { type: 'spin_count', threshold: 10 }
  },
  {
    name: 'Spin Legend',
    description: 'Completed 50 spins',
    icon: '🏆',
    criteria: { type: 'spin_count', threshold: 50 }
  },
  {
    name: 'On Fire',
  ...
  },
  {
    ...
    icon: '⭐',
    criteria: { type: 'points_earned', threshold: 100 }
  },
  {
    name: 'Big Spender',
